...
import { SelectOption, MetaTags, SearchType } from '@/lib/types';
...
export function Search({ metaTags, type }: { metaTags: MetaTags; type: SearchType }) {
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://karayaka.ru/${type}" />
