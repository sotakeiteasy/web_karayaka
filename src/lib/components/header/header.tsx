  ...
  return (
    <header className={styles.header}>
      ...
      <nav className={`${styles.nav} ${styles.fill}`}>
        ...
        <div className={`${styles.navLinksContainer} ${isBurgerMenuOpen ? styles.open : ''}`}>
          <div className={styles.title}>
            ...
            <button onClick={() => setIsBurgerMenuOpen(false)}>
          ...
          <div className={styles.mobileLangSwitcher}>
            <LanguageSwitcher lang="en">
              <button
                className={`${styles.mobileLangButton} ${currentLang === "en" ? styles.active : ""}`}
              >
                English
              </button>
            </LanguageSwitcher>
            <LanguageSwitcher lang="ru">
              <button
                className={`${styles.mobileLangButton} ${currentLang === "ru" ? styles.active : ""}`}
              >
                Русский
              </button>
            </LanguageSwitcher>
